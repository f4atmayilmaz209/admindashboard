    ...
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
       ...
       <div className="flex justify-between flex-wrap gap-4">
        ...
        />
            ...
            error={errors?.email}
        />
            <InputField label="Password" name="password" type="password" defaultValue={data?.username} register={register}
       ...
       <div className="flex justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
            ...
            <select className="w-full ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm" defaultValue={data?.sex}>
